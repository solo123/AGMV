<%@ Page Language="C#" MasterPageFile="~/AdminWeb/public/AdminPopup.master" AutoEventWireup="true" Inherits="CustomerInfo" Title="Untitled Page" Codebehind="CustomerInfo.aspx.cs" %>
...
userId:
        ...
        <div class="toolbox listButtons">
            <ul>
                ...
                Text="Edit"></asp:LinkButton></li></ul><div style="clear:both"></div>
        </div>
