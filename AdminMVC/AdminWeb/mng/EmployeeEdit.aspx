<%@ Page Language="C#" MasterPageFile="~/AdminWeb/public/AdminContent.master" AutoEventWireup="true" Inherits="EmployeeEdit" Title="歐美旅遊-用戶管理" Codebehind="EmployeeEdit.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="toolbox listButtons">
        <ul>
            <li><a href="EmployeeList.aspx">返囬</a></li><li>
                <asp:LinkButton ID="btnSave" OnClick="btnSave_Click" runat="server" Enabled='<%# PageLogic.CheckActionAuth("auth_EmployeeEdit") %>'>保存</asp:LinkButton></li><li><a href="AddEmployee.aspx" visible='<%# PageLogic.CheckActionAuth("auth_EmployeeNew") %>'>新增</a></li><li><asp:Label ID="txtToolMessage" runat="server" ForeColor="Red"></asp:Label></li><li><asp:HyperLink ID="lnkChgPwd" Text="修改密码" runat=server Enabled='<%# PageLogic.CheckActionAuth("ASP.ChangeSignIn_aspx") %>' /></li><li><asp:HyperLink ID="lnkAuth" Text="权限" runat=server Enabled='<%# PageLogic.CheckActionAuth("ASP.menuauth_aspx") %>' /></li></ul>
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:DropDownList ID="seleStatus" runat="server" SelectedValue='<%# Bind("status") %>'>
                            <asp:ListItem Text="Alow Login" Value="1" />
                            <asp:ListItem Text="No Login" Value="0" />
                        </asp:DropDownList>
                    </td>
                    <td>Display Name:</td>
                    <td>
                        <asp:TextBox ID="txtNickname" runat="server" Text='<%# Bind("nickname") %>'></asp:TextBox><asp:RequiredFieldValidator
                            ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtNickname" Display="Dynamic" SetFocusOnError="True"></asp:RequiredFieldValidator></td>
                </tr>
                <tr>
                    <td>
    ...
    <asp:ObjectDataSource ID="EmployeeDataset" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetEmployeeDetail" TypeName="com.Omei.BLL.Admin.EmployeeBiz" UpdateMethod="UpdateEmployeeDetail">
        <UpdateParameters>
