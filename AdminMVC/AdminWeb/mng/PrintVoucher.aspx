<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="PrintMaster.master" Title="Print Ticket" 
    Inherits="PrintVoucher" Theme="themePrint" Codebehind="PrintVoucher.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <asp:ObjectDataSource ID="OrderDetailDataset" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="GetData" TypeName="com.Omei.DLL.DS_OrdersTableAdapters.ordersDetailTableAdapter">
        <SelectParameters>
                    ...
                    <td>
                        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td height="29">
                                    <asp:Label ID="TourNameLabel" runat="server" Text='<%# Bind("TourName") %>'></asp:Label>
                                    <asp:Label ID="lbTourDay" runat="server" Text='<%# OmeiStatus.DayAndNightText(Eval("TourDay"), "en") %>' />
                                    </td>
                                <td>
                                </td>
                                <td align="right" nowrap="noWrap">
                            ...
                            <tr>
                                ...
                                <td height="29">
                                    <asp:Label ID="startDateLabel" runat="server" Text='<%# Eval("startDate", "{0:d}") %>'></asp:Label></td>
                                <td>
                                </td>
                                <td align="right" nowrap="noWrap">
                            ...
                            <tr>
                                ...
                                <td colspan="2" rowspan="3" valign="top" style="padding:6px;">
                                    <table cellpadding="2" cellspacing="0" style="width: 100%">
                                        <tr>
                                            <td>
                                                <asp:Label ID="subTitleLabel" runat="server" Text='<%# Bind("subTitle") %>'></asp:Label></td>
                                        </tr>
                                        <tr>
                    ...
                    <td>
                        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td height="29">
                                    <asp:Label ID="Label13" runat="server" Text='<%# Bind("TourName") %>'></asp:Label>
                                    <asp:Label ID="Label14" runat="server" Text='<%# OmeiStatus.DayAndNightText(Eval("TourDay"), "en") %>' />
                                    </td>
                                <td>
                                </td>
                                <td align="right" nowrap="noWrap">
                            ...
                            <tr>
                                ...
                                <td height="29">
                                    <asp:Label ID="Label16" runat="server" Text='<%# Eval("startDate", "{0:d}") %>'></asp:Label></td>
                                <td>
                                </td>
                                <td align="right" nowrap="noWrap">
                            ...
                            <tr>
                                ...
                                <td colspan="2" rowspan="3" valign="top" style="padding:6px;">
                                    <table cellpadding="2" cellspacing="0" style="width: 100%">
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label19" runat="server" Text='<%# Bind("subTitle") %>'></asp:Label></td>
                                        </tr>
                                        <tr>
