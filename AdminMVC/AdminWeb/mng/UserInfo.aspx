<%@ Page Language="C#" MasterPageFile="~/AdminWeb/public/AdminContent.master" AutoEventWireup="true" Inherits="UserInfo" Title="Untitled Page" Codebehind="UserInfo.aspx.cs" %>
...
userId:
        ...
        <div class="toolbox listButtons">
            <ul>
                ...
                <li>
                    <asp:HyperLink ID="lnkSearch" NavigateUrl="SearchCustomer.aspx" runat="server">Search</asp:HyperLink>
                </li>
